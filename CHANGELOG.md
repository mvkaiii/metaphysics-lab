...
這份文件保存正式版本與尚未發布變更的技術紀錄。第一次使用 Metaphysics Lab 請先看 `README.md`；目前正式版本為 v1.5.0，正式發布說明見 `docs/發布說明-v1.5.0.md`。
...
- 正式 release commit 為 `66f604222caadac0209125a78674c3f4491c4b99`；release 本身不修改八字／紫微公式、Phase 3 ranking authority、Phase 4/5 邊界或 capability maturity。
