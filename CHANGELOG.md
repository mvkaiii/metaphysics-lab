...
- 正式 Release identity 為 `v1.7.1`；AI Distribution Runtime **仍維持 `1.2-exp`**，Project Contract 仍為 `1.2`，Runtime Schema / Case Schema 仍為 `1.1`。
...
- deterministic User Package：`Metaphysics-Lab-v1.7.1-User-Package.zip`，SHA256 `771f8493cd07b298c7971f38c601ce17a8acfcce5dab43c72e245f7b282943e8`。
