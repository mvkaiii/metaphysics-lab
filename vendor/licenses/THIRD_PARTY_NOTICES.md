...
Metaphysics Lab bundles the following pinned dependency artifacts under Project-private runtime authority. Repository storage uses checksum-protected base64 shards; runtime materialization recreates the private package trees before import.
